...
export function MovieCard({ movie, isSelected, onSelect }: MovieCardProps) {
    ...
    const imdbUrl = movie.id?.startsWith('tt')
        ...
        >
            <CardContent className="p-0 aspect-[2/3] relative">
                ...
                <a
                    ...
                    className="absolute top-2 right-2 z-30 bg-yellow-500/90 text-black text-[10px] font-mono font-bold px-1.5 py-0.5 shadow hover:bg-yellow-400 transition-colors block tracking-wider cursor-pointer"
